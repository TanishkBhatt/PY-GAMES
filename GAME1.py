...
if scorecard["USER"] > scorecard["COMPUTER"]: print("CONGARTS! YOU HAVE WON THE GAME!\n")
elif scorecard["USER"] < scorecard["COMPUTER"] : print("BAD LUCK THIS TIME! YOU HAVE LOST!\n")
else: 
    print("OHH! THATS A TIED GAME!\n")